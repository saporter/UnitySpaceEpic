...
public class F3DPlanetEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
		...
		myTarget.FlattenOrbit = EditorGUILayout.Toggle("Flatten Orbit to Y Axis", myTarget.FlattenOrbit);
    ...
    void OnSceneGUI()
    {
        ...
        if (myTarget.OrbitPoint && myTarget.ShowOrbit)
        {
			...
			Handles.Disc(Quaternion.identity, myTarget.OrbitPoint.position, myTarget.FlattenOrbit ? Vector3.up : myTarget.transform.up, distToOrbitPoint, false, 1);
        }       
    }
}
